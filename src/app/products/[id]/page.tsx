...
import { Star, MessageSquare, Share2, Heart, Languages, Loader2 } from 'lucide-react';
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="space-y-2">
            ...
            <p className="font-bold text-primary text-3xl">
             ...
             <p className="text-sm text-muted-foreground">Condition: <span className="font-medium text-foreground">{product.condition}</span></p>
          </div>
