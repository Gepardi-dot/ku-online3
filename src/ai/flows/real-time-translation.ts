 ...
 *
 * - translateText - A function that handles the real-time translation process.
...
const TranslateTextInputSchema = z.object({
  ...
  targetLanguage: z.string().describe('The language to translate the text to (Kurdish, Arabic, or English).'),
});
...
const prompt = ai.definePrompt({
  ...
  You will translate text from one language to another.
